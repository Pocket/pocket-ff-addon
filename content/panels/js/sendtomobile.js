var PKT_SENDTOMOBILE = (function() {
    ...
    function _swapPlaceholder(data) {
        ...
        $('#pkt_ext_articleinfo').empty();
        $('#pkt_ext_articleinfo').append(Handlebars.templates.ho2_articleinfo(info));
    }
        ...
        $('#pkt_ext_sendtomobile_button').click(function() {
            thePKT_SAVED.sendMessage('getMobileDownload', {}, function(data) {
                if (data.status === 1) {
                    ...
                    thePKT_SAVED.sendMessage('resizePanel', { width: width, height: 270 });
                }
            });
        });
    }
